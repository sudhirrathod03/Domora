    ...
    <nav className="bg-white border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          {user ? (
            <h1>{user.name} <button className="bg-[#E76F2E] p-3 text-white px-5 py-2 rounded-full font-semibold hover:bg-[#d65f24] hover:shadow-md hover:-translate-y-0.5 transition-all duration-200" onClick={logout}>Logout</button> </h1>
